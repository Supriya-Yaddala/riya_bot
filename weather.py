...
def weather(update,context):
  try:
    ...
    weather_api_url="https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=2ff1f4ca68a6514981173c3440965c04"
...
def main():
    ...
    updater=Updater(token="1018803634:AAFOe0WUAz5hrlx36fy6mFxppPq1T69nAgk")
